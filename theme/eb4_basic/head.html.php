                            ...
                            <ul class="top-header-nav list-unstyled">
                                <li><a href="<?php echo G5_SHOP_URL; ?>/cart.php">
                                        <div class="d-flex flex-row align-items-center gap-2">
                                            ...
                                            <span class="title-btn-count"><?php echo get_wishlist_datas_count(); ?></span>
                                        </div>
                                    </a></li>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        <div class="sidebar-left offcanvas offcanvas-start" tabindex="-1" id="offcanvasLeft" aria-controls="offcanvasLeftLabel">
                            <div class="sidebar-left-content">
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <?php if ($is_megamenu == 'yes') { ?>
                                        <li class="dropdown">
                                            ...
                                            <div class="dropdown-menu new-mega-menu">
                                                <ul>
                                                    <?php if (is_array($menu)) { ?>
                                                        <?php foreach ($menu as $key => $menu_1) { ?>
                                                            <li class="dropdown-submenu">
                                                                <a href="<?php echo $menu_1['me_link']; ?>" target="_<?php echo $menu_1['me_target']; ?>" class="dropdown-item nav-link">
                                                                    <span><?php echo $menu_1['me_name'] ?></span>
                                    ...
                                    <li class="navbar-nav-home d-none">
                                ...
                                <?php /* ---------- 모바일용 컨텐츠 시작 // 991픽셀 이하에서만 출력 ---------- */ ?>
                                <div class="sidebar-mobile-menu d-none">
