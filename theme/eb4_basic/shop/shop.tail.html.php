	...
	<footer class="footer">
		<div class="container">
			<div class="footer-top">
				<div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between">
					<div class="footer-logo mb-4 mb-lg-0">
						<img src="<?php echo EYOOM_THEME_URL; ?>/image/site_logo_white.svg" class="site-logo" alt="<?php echo $config['cf_title']; ?>">
					</div>
			...
			<div class="footer-cont-info">
				...
				<?php } ?>
				<div class="footer-info-group mb-3">
					<div class="top-line d-flex flex-column flex-lg-row">
						<span>CS CENTER 1522-2041</span>
						<span class="info-divider d-none d-lg-block">|</span>
						<span>평일 10:00 ~ 17:00 (점심 12:00 ~ 13:00)</span>
					</div>
					<div class="bottom-line d-flex flex-column flex-lg-row">
						<span>soo@p2u.kr</span>
						<span class="info-divider d-none d-lg-block">|</span>
				...
				<div class="footer-info-group mb-3">
					...
					<div class="bottom-line d-flex flex-column flex-lg-row">
						<span>사업자 등록번호 : 443-86-024-22</span>
						<span class="info-divider d-none d-lg-block">|</span>
				...
				<div class="footer-copyright">
					<span>Copyright &copy; P2U :: 포인투유. All Rights Reserved.</span>
				</div>
			</div>
